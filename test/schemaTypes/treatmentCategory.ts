...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      validation: reqI18n('Kort beskrivelse'),
    },
    {
      name: 'longDescription',
      title: 'Utvidet beskrivelse',
      type: 'internationalizedArrayBlockContent',
      validation: requiredNoEnBlockContent('Utvidet beskrivelse'),
    },
    {
      name: 'icon',
      title: 'Ikon',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          title: 'Primær lenke',
          type: 'string',
          description: 'Tom = booking med kategori (f.eks. /booking?kategori=fertilitet).',
        },
        {
          name: 'secondaryPath',
