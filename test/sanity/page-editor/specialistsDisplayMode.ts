/**
 * Studio copy of specialists displayMode helpers (Sanity package cannot use @/ aliases).
 * Keep in sync with src/lib/sanity/specialists-display-mode.ts
 */
...
export function specialistsDisplayModeChip(displayMode: unknown): string {
