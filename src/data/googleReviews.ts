export type ReviewSource = 'google' | 'legelisten';
...
export const googleReviews: GoogleReview[] = [
  ...
  },
  {
    ...
    name: "Anonym",
    rating: 5,
    text: "Ingvild Aanerud er en dyktig osteopat med stor kunnskap. Hun er varm, lyttende, trygg og har et stort engasjement for pasientene sine. Ingvild er spesielt god på kvinnehelse. Jeg kan virkelig anbefale henne.",
    date: "7 måneder siden",
    source: "legelisten",
  },
];
