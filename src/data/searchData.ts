...
export const searchItems: SearchItem[] = [
  ...
  { label: 'Fødselsskader', path: '/behandlinger/graviditet/fodselsskader', category: 'Graviditet', keywords: ['fødsel', 'ruptur', 'sphincter', 'bekkenbunn'] },
  ...
  { label: 'Spontanabort', path: '/behandlinger/graviditet/spontanabort', category: 'Graviditet', keywords: ['abort', 'tidlig graviditet', 'missed abortion'] },
