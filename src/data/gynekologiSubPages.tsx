...
export const gynekologiSubPages: Record<string, SubTreatmentContent> = {
  ...
  fostermedisin: {
    ...
    reasons: [
      { n: "01", title: "Tidlig ultralyd", desc: "Bekreftelse av svangerskap, antall fostre og terminbestemmelse." },
      { n: "02", title: "NIPT", desc: "Tidlig blodprøve som vurderer risiko for kromosomavvik." },
      { n: "03", title: "Rutineultralyd uke 17–19", desc: "Grundig gjennomgang av anatomi og tilvekst." },
      { n: "04", title: "Tilvekstkontroll", desc: "Vurdering av fosterets vekst senere i svangerskapet." },
      { n: "05", title: "Målrettet undersøkelse", desc: "Når det er funn eller særlige bekymringer som må vurderes nærmere." },
      { n: "06", title: "3D/4D-ultralyd", desc: "Visuell undersøkelse når det er medisinsk indikasjon eller ønske." },
    ],
    promises: standardPromises,
    related: [
  ...
  nipt: {
    ...
    reasons: [
      { n: "01", title: "Trisomi 21 (Downs syndrom)", desc: "Høy treffsikkerhet." },
      { n: "02", title: "Trisomi 18 (Edwards syndrom)", desc: "Vurderes med høy presisjon." },
      { n: "03", title: "Trisomi 13 (Pataus syndrom)", desc: "Inkludert i analysen." },
      { n: "04", title: "Kjønnskromosomavvik", desc: "Kan inkluderes etter ønske." },
      { n: "05", title: "Kjønn", desc: "Kan oppgis fra uke 10 om ønskelig." },
      { n: "06", title: "Tvillinger", desc: "NIPT kan utføres ved tvillingsvangerskap — informeres om begrensninger." },
    ],
    promises: standardPromises,
    related: [
