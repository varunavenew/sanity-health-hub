...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    subcategories: [
      ...
      { label: 'PCOS', path: '/behandlinger/gynekologi/pcos' },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { label: 'IVF', path: '/behandlinger/fertilitet/ivf' },
      { label: 'IUI', path: '/behandlinger/fertilitet/iui' },
      { label: 'Nedfrysing', path: '/behandlinger/fertilitet/nedfrysing' },
      { label: 'Eggdonasjon', path: '/behandlinger/fertilitet/eggdonasjon' },
      { label: 'Mannlig fertilitet', path: '/behandlinger/fertilitet/mannlig-fertilitet' },
      { label: 'Psykisk helsehjelp', path: '/behandlinger/fertilitet/psykisk-helsehjelp' },
      { label: 'PGT', path: '/behandlinger/fertilitet/pgt' },
