    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Svangerskapsoppfølging", price: "fra 2.100,-", duration: "30 min", path: "/behandlinger/graviditet/svangerskapsoppfolging" },
          ...
          { name: "PMOS / hormonforstyrrelser", price: "fra 3.200,-", duration: "45 min", path: "/behandlinger/gynekologi/pmos" },
