  ...
  "urologi/robotkirurgi": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Ved robotassistert prostatakirurgi er målet å fjerne svulstvev fullstendig, samtidig som friskt vev og viktige nervebaner bevares. Ved å vurdere vevet histologisk underveis i operasjonen kan kirurgen tilpasse inngrepet presist – for tryggere kreftkontroll og best mulig bevaring av funksjon.",
      },
      {
        id: "vare-spesialister",
        heading: "Våre spesialister",
        content: "**Bjørn Brennhovd** introduserte robotassistert kirurgi i Norge i 2004, etter å ha ledet teamet for alle urologiske kreftoperasjoner ved Radiumhospitalet i mange år. Årlig har han utført 100–150 inngrep og har aktivt deltatt i opplæringen av helsepersonell i Norge. Bjørn har vært medisinsk ansvarlig ved urologisk avdeling på Radiumhospitalet siden 2005 og har hatt ledelsen for all urologisk robotassistert kirurgi ved Oslo universitetssykehus siden 2014. Han er nasjonal hovedutprøver i en stor skandinavisk multisenterstudie om behandling av høyrisiko prostatakreft.\n\n**Nicolai Wessel** er en erfaren spesialist innen kirurgi og urologi med spesialkompetanse innen laparoskopiske urologiske prosedyrer og behandling av prostatakreft. Tidligere overlege ved Aker Sykehus, regnes han blant Europas mest erfarne kirurger og urologer innen robotassistert kirurgi. Nicolai begynte sitt arbeid med robotassistert kirurgi i 2007, etter fem års erfaring med laparoskopisk nyre- og prostatakirurgi, og har utført over 1.400 robotassisterte prostatakreftoperasjoner.\n\n**Thomas Fredrik Thaulow** er en av landets fremste spesialister innen endoskopiske operasjoner og utmerker seg som en av de mest kompetente i fagmiljøet når det gjelder å utføre svært komplekse inngrep med laparoskopi og hysteroskopi. Han er en nøkkelperson i det dedikerte endometriose-teamet ved Ullevål sykehus, hvor han diagnostiserer og behandler de mest utfordrende tilfellene fra hele landet, og bidrar med sin ekspertise ved CMedical Majorstuen.",
      },
    ],
