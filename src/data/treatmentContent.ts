...
export const treatmentContent: Record<string, TreatmentData> = {
    ...
    "gynekologi/fostermedisin": {
        ...
        sections: [
            ...
            { heading: "Fosterdiagnostikk", content: "[Dr. Ashi Ahmad](/booking?spesialist=ashi-ahmad&klinikk=majorstuen) har fått virksomhetsgodkjenning for å tilby fosterdiagnostikk til gravide kvinner. Ashi Ahmad er spesialist i gynekologi og fødselshjelp og har doktorgrad i epidemiologi og fødselshjelp." },
        ],
        faqs: [
            { question: "Henvisning", answer: "Ingen henvisning nødvendig. Vi er en privathelseklinikk og har derfor ingen refusjonsavtale med det offentlige." },
            { question: "Ventetid", answer: "Vi har fra ingen til veldig korte ventetider. Generelt sett skal du få hjelp innen en uke." },
