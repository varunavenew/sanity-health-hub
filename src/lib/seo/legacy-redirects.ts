...
const EN_SPECIALIST_REDIRECTS: LegacyRedirect[] = [
  ...
  perm("/en/specialists/lars-eldar-myrseth", "/en/specialists/gilbert-moatshe"),
  ...
  perm("/en/specialists/kjersti-margrete-finsrud", "/en/specialists/linn-myrtveit-stensrud"),
