...
export const ICONS = {
  ...
  // Extended
  "interdisciplinary-sym": c(InterdisciplinaryIcon),
  "hormones-sym": c(HormonesIcon),
  "hysteroscopy-sym": c(HysteroscopyIcon),
  "robotic-arm-sym": c(RoboticArmIcon),
  "pregnancy-loss-sym": c(PregnancyLossIcon),
  "pregnancy-bump-sym": c(PregnancyBumpIcon),
  "bladder-sym": c(BladderIcon),
  "foreskin-sym": c(ForeskinIcon),
  "male-infertility-sym": c(MaleInfertilityIcon),
  "kidneys-sym": c(KidneysIcon),
  "refertilisation-sym": c(RefertilisationIcon),
  "sterilisation-sym": c(SterilisationIcon),
  "testicles-sym": c(TesticlesIcon),
  "egg-freeze-sym": c(EggFreezeIcon),
  "donor-treatment-sym": c(DonorTreatmentIcon),
  "sperm-analysis-sym": c(SpermAnalysisIcon),
  "fertility-team-sym": c(FertilityTeamIcon),
  "assisted-fertilisation-sym": c(AssistedFertilisationIcon),
  "foot-sym": c(FootIcon),
  "hip-sym": c(HipIcon),
  "arm-sym": c(ArmIcon),
  "knee-sym": c(KneeIcon),
  "shoulder-sym": c(ShoulderIcon),
  "endocrinology-sym": c(EndocrinologyIcon),
  "dermatology-sym": c(DermatologyIcon),
  "nutrition-sym": c(NutritionIcon),
  "gastro-surgery-sym": c(GastroSurgeryIcon),
  "osteopathy-sym": c(OsteopathyIcon),
  "plastic-surgery-sym": c(PlasticSurgeryIcon),
  "psychology-sym": c(PsychologyIcon),
  "rheumatology-sym": c(RheumatologyIcon),
  "sexology-sym": c(SexologyIcon),
  "varicose-veins-sym": c(VaricoseVeinsIcon),
  "skin-health-sym": c(SkinHealthIcon),
  ...
  "endometriose-cl": c(ClEndometrioseIcon),
  "overgangsalder-cl": c(ClOvergangsalderIcon),
  "vaginale-fremfall-cl": c(ClVaginaleFremfallIcon),
  "blodningsforstyrrelser-cl": c(ClBlodningsforstyrrelserIcon),
  "celleforandringer-cl": c(ClCelleforandringerIcon),
  "cyster-cl": c(ClCysterIcon),
  "fjerne-livmor-cl": c(ClFjerneLivmorIcon),
  "graviditet-cl": c(ClGraviditetIcon),
  "gynekologisk-kirurgi-cl": c(ClGynekologiskKirurgiIcon),
  "hormonforstyrrelser-cl": c(ClHormonforstyrrelserIcon),
  "hysteroskopi-cl": c(ClHysteroskopiIcon),
  "labiaplastikk-cl": c(ClLabiaplastikkIcon),
  "robotkirurgi-gyn-cl": c(ClRobotkirurgiGynIcon),
  "spontanabort-cl": c(ClSpontanabortIcon),
  "vulvalidelser-cl": c(ClVulvalidelserIcon),
  "pms-pmdd-cl": c(ClPmsPmddIcon),
  "vaginal-torrhet-cl": c(ClVaginalTorrhetIcon),
  "tverrfaglig-team-cl": c(ClTverrfagligTeamIcon),
  // Fertilitet
  "infertilitet-cl": c(ClInfertilitetIcon),
  "assistert-befruktning-cl": c(ClAssistertBefruktningIcon),
  "ivf-cl": c(ClIvfIcon),
  "eggfrys-cl": c(ClEggfrysIcon),
  "donorbehandling-cl": c(ClDonorbehandlingIcon),
  "saedanalyse-cl": c(ClSaedanalyseIcon),
  "fertilitetsteamet-cl": c(ClFertilitetsteametIcon),
  "inseminasjon-cl": c(ClInseminasjonIcon),
  "eggdonasjon-cl": c(ClEggdonasjonIcon),
  "saeddonasjon-cl": c(ClSaeddonasjonIcon),
  // Urologi
  "blaere-cl": c(ClBlaereIcon),
  "forhud-cl": c(ClForhudIcon),
  "mannlig-infertilitet-cl": c(ClMannligInfertilitetIcon),
  "nyrer-cl": c(ClNyrerIcon),
  "prostata-cl": c(ClProstataIcon),
  "refertilisering-cl": c(ClRefertiliseringIcon),
  "robotkirurgi-uro-cl": c(ClRobotkirurgiUroIcon),
  "sterilisering-cl": c(ClSteriliseringIcon),
  "testikler-cl": c(ClTestiklerIcon),
  "urinveisinfeksjon-cl": c(ClUrinveisinfeksjonIcon),
  "erektil-dysfunksjon-cl": c(ClErektilDysfunksjonIcon),
  // Ortopedi
  "fot-ankel-cl": c(ClFotAnkelIcon),
  "hofte-cl": c(ClHofteIcon),
  "hand-albue-cl": c(ClHandAlbueIcon),
  "kne-cl": c(ClKneIcon),
  "skulder-cl": c(ClSkulderIcon),
  // Flere fagområder
  "endokrinologi-cl": c(ClEndokrinologiIcon),
  "hudlege-cl": c(ClHudlegeIcon),
  "ernaringsfysiolog-cl": c(ClErnaringsfysiologIcon),
  "gastrokirurgi-cl": c(ClGastrokirurgiIcon),
  "osteopati-cl": c(ClOsteopatiIcon),
  "plastikkirurgi-cl": c(ClPlastikkirurgiIcon),
  "psykologi-cl": c(ClPsykologiIcon),
  "revmatologi-cl": c(ClRevmatologiIcon),
  "sexologi-cl": c(ClSexologiIcon),
  "areknuter-cl": c(ClAreknuterIcon),
  "hudhelse-cl": c(ClHudhelseIcon),
  "overvektskirurgi-cl": c(ClOvervektskirurgiIcon),
