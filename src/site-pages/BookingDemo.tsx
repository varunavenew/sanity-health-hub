                  ...
                  <div key={spec.name} className="relative">
                    ...
                    >
                      <div className="w-14 h-14 rounded-sm overflow-hidden mb-2.5">
                        <AssetImg src={spec.image} alt={spec.name} className="w-full h-full object-cover object-top" />
                      </div>
                        ...
                        {availableSlots.map((slot, index) => (
                          ...
                          >
                            <div className="w-10 h-10 rounded-sm overflow-hidden flex-shrink-0">
                              <AssetImg src={slot.specialist.image} alt={slot.specialist.name} className="w-full h-full object-cover object-top" />
                            </div>
