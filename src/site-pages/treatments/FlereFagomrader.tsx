    ...
    <PageLayout isChatOpen={isChatOpen}>
      ...
      <section className="bg-background py-16 md:py-20">
        <div className="container mx-auto px-6 md:px-16 max-w-4xl">
          <p className="text-xs tracking-wide text-foreground/60 mb-4 uppercase">Øvrige fagområder</p>
        ...
        <div className="container mx-auto px-6 md:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="max-w-2xl mb-14">
              <p className="text-xs tracking-wide text-foreground/60 mb-4 uppercase">Fagområder</p>
              <h2 className="text-3xl md:text-5xl font-light leading-tight">Finn fagfeltet som passer deg.</h2>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {clusters.map((c) => (
                <div key={c.title} className="bg-background p-7 rounded-sm border border-border/40 flex flex-col">
      ...
      <section className="bg-background py-20 md:py-28">
        <div className="container mx-auto px-6 md:px-16">
          <div className="max-w-6xl mx-auto">
            <div className="max-w-2xl mb-14">
              <p className="text-xs tracking-wide text-foreground/60 mb-4 uppercase">Alle spesialister</p>
