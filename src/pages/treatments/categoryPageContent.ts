...
const fertilitet: CategoryNewContent = {
  ...
  serviceLinks: {
    ...
    "IVF": "/behandlinger/fertilitet/assistert-befruktning",
    "IUI": "/behandlinger/fertilitet/assistert-befruktning",
    "Nedfrysing": "/behandlinger/fertilitet/eggfrys",
    "Eggdonasjon": "/behandlinger/fertilitet/donorbehandling",
    "Mannlig fertilitet": "/behandlinger/fertilitet/saedanalyse",
    "Psykisk helsehjelp": "/behandlinger/fertilitet/infertilitet",
    "PGT": "/behandlinger/fertilitet/assistert-befruktning",
  },
  groups: [
    { label: "Kartlegging", serviceNames: ["Fertilitetssjekk", "Mannlig fertilitet"] },
    { label: "Assistert befruktning", serviceNames: ["IVF", "IUI", "Eggdonasjon"] },
    { label: "For fremtiden", serviceNames: ["Nedfrysing", "PGT"] },
    { label: "Støtte underveis", serviceNames: ["Psykisk helsehjelp"] },
  ],
  faqs: standardFaqs,
  journey: [
