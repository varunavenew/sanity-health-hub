...
const staticCategoryData: Record<string, CategoryData> = {
 ...
 heroImage: fertilitetImg,
  ...
  { name: "IVF", path: "/behandlinger/fertilitet/assistert-befruktning" },
  { name: "IUI", path: "/behandlinger/fertilitet/assistert-befruktning" },
  { name: "Nedfrysing", path: "/behandlinger/fertilitet/eggfrys" },
  { name: "Eggdonasjon", path: "/behandlinger/fertilitet/donorbehandling" },
  { name: "Mannlig fertilitet", path: "/behandlinger/fertilitet/saedanalyse" },
  { name: "Psykisk helsehjelp", path: "/behandlinger/fertilitet/infertilitet" },
  { name: "PGT", path: "/behandlinger/fertilitet/assistert-befruktning" },
  ],
 faqs: [
 { question: "Henvisning", answer: "Ingen henvisning nødvendig. Vi er en privathelseklinikk og har derfor ingen refusjonsavtale med det offentlige." },
 { question: "Ventetid", answer: "Vi har fra ingen til veldig korte ventetider. Generelt sett skal du få hjelp innen en uke. Dette varierer selvfølgelig noe avhengig av hva du trenger hjelp med. Enkle konsultasjoner får du raskere bestilt sammenlignet med operasjoner for eksempel. Ta kontakt med oss så finner vi en tid som passer deg!" },
