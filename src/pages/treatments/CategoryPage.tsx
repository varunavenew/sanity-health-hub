...
const staticCategoryData: Record<string, CategoryData> = {
  urologi: {
    ...
    description: "Urologi er en medisinsk spesialdisiplin som tar seg av problemer med nyrer, urinblære, urinledere og urinrør hos begge kjønn, samt prostata og mannlige kjønnsorganer.",
    ...
    faqs: [
      ...
      { question: "Sykemelding", answer: "Våre spesialister kan skrive sykemelding hvis det er medisinsk grunnlag for det." },
      { question: "Utredning", answer: "Vi tilbyr grundig utredning innen alle våre fagområder." },
      { question: "Selskapet", answer: "CMedical er Nordens ledende klinikk for livet og underlivet. Siden 2002 har over 150 000 pasienter fått behandling hos oss." },
    ],
  },
  fertilitet: {
    id: "fertilitet", title: "Fertilitet", subtitle: "Kort ventetid • Ingen henvisning",
    description: "Vårt fertilitetssenter tilbyr omfattende utredning og behandling for par og enslige som ønsker barn.",
  ...
  gynekologi: {
    id: "gynekologi", title: "Gynekologi", subtitle: "Kort ventetid • Ingen henvisning",
    description: "Velkommen til vår gynekologiklinikk hvor kvinner i alle aldre får hjelp med underlivshelse, blødning, cystekontroll, graviditet og hormonell behandling.",
  ...
  "flere-fagomrader": {
    ...
    description: "Vi tilbyr et bredt spekter av spesialisttjenester innenfor ulike medisinske fagområder.",
  ...
  ortopedi: {
    id: "ortopedi", title: "Ortopedi", subtitle: "Kort ventetid • Ingen henvisning",
    description: "Ortopedi er en medisinsk spesialitet som tar seg av problemer med muskler, ledd, skjelett og bindevev.",
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-base md:text-[17px] text-foreground/80 leading-relaxed font-light">{category.description}</p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <p className="text-sm text-muted-foreground mb-3 font-light">Våre behandlinger</p>
              <h2 className="text-3xl md:text-4xl font-normal text-foreground mb-4">{category.title}tjenester</h2>
