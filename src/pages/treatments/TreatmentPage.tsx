              ...
              <div key={spec.slug} className="rounded-2xl border border-border overflow-hidden bg-background">
                ...
                <div className="flex items-center gap-2 px-5 py-3.5 border-t border-border/50">
                  <Button
                    variant="outline"
                    size="sm"
                    className="text-xs rounded-2xl md:rounded-full font-light flex-1"
                        ...
                        if (trimmed.startsWith("- ")) {
                          return (
                            <div key={j} className="flex items-start gap-3 pl-1">
                              <div className="w-1.5 h-1.5 rounded-2xl md:rounded-full bg-foreground/40 mt-2.5 flex-shrink-0" />
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-brand-dark rounded-2xl p-8 md:p-12 text-center mb-14">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Button
                  size="lg"
                  className="bg-accent text-accent-foreground hover:bg-accent/90 rounded-2xl md:rounded-full px-8 font-normal"
                  onClick={() => navigate(`/booking?kategori=${categoryId}`)}
                >
                ...
                <Button
                  size="lg"
                  variant="ghost"
                  className="border border-white/20 text-white bg-transparent hover:bg-white/10 rounded-2xl md:rounded-full px-8 font-normal"
