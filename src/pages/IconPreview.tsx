...
const GROUPS: Group[] = [
  ...
  {
    title: "11 — Undertjenester: Gynekologi (symbolske, unike)",
    intro:
      "Hvert ikon er nå unikt og symbolsk — ingen saks for «Fjerne livmor», ingen repetert dråpe. Mykt, verdig og lett gjenkjennelig.",
    pairs: [
      ...
      { label: "Fjerne livmor", usage: "/gynekologi/fjerne-livmor — IKKE saks lenger", lucide: "scissors", custom: "hysterectomy-sym" },
      { label: "PMS og PMDD", usage: "/gynekologi/pms-pmdd", lucide: "heart", custom: "mood-wave-sym" },
      { label: "Labiaplastikk", usage: "/gynekologi/labiaplastikk", lucide: "flower", custom: "butterfly-sym" },
      { label: "Vaginal tørrhet", usage: "/gynekologi/vaginal-torrhet", lucide: "droplets", custom: "hydration-balance-sym" },
      ...
      { label: "Robotassistert kirurgi", usage: "/gynekologi/robotkirurgi", lucide: "bot", custom: "robot-surgery" },
    ],
  },
  {
    title: "12 — Undertjenester: Fertilitet (symbolske, unike)",
    intro: "Hver fertilitets-tjeneste har sitt eget symbol — ingen sprøyte, ingen gjentatt egg-form.",
    pairs: [
      { label: "IVF-behandling", usage: "Fertilitet-side, prisliste", lucide: "baby", custom: "ivf-sym" },
      { label: "Fertilitetsutredning", usage: "Fertilitet-side", lucide: "microscope", custom: "fertility-assessment-sym" },
      { label: "Eggdonasjon", usage: "Fertilitet-side", lucide: "circle-dot", custom: "egg-donation-sym" },
      { label: "Sæddonasjon", usage: "Fertilitet-side", lucide: "activity", custom: "sperm-donation-sym" },
      { label: "IUI / inseminasjon", usage: "Fertilitet-side", lucide: "syringe", custom: "insemination-sym" },
      { label: "Graviditet (oppfølging)", usage: "Fertilitet, kvinnehelse", lucide: "baby", custom: "pregnancy" },
    ],
  },
  {
    title: "13 — Undertjenester: Urologi (symbolske, unike)",
    intro: "Anatomisk nøytrale symboler — ingen saks for sirkumsisjon, ingen gjentatt dråpe.",
    pairs: [
      { label: "Prostata-undersøkelse", usage: "/urologi/prostata", lucide: "stethoscope", custom: "prostate-sym" },
      { label: "Urinveisinfeksjon", usage: "Urologi-side", lucide: "droplets", custom: "urinary-health-sym" },
      { label: "Forstørret prostata", usage: "Urologi, PromoBanner", lucide: "user", custom: "prostate-sym" },
      { label: "Erektil dysfunksjon", usage: "Urologi-side", lucide: "heart-pulse", custom: "vitality-sym" },
      { label: "Sirkumsisjon", usage: "Urologi-side — IKKE saks", lucide: "scissors", custom: "circumcision-sym" },
    ],
  },
  {
