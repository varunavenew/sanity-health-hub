...
const staticContent = (
  <>
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Introduksjon</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Behandlingsansvarlig</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Hvor vi henter dine opplysninger fra</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Kategorier av behandlede personopplysninger</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Formålet med behandlingen av dine personopplysninger</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Hvem vi deler dine personopplysninger med</h2>
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Helsetjenester eller annet helsepersonell</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Offentlige myndigheter</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Offentlige helseregistre</h3>
      <p>Vi deler opplysninger vi er pålagt å rapportere til helseregistre, som kreftregisteret.</p>
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Databehandlere</h3>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Hvordan vi sikrer dine personopplysninger</h2>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Hvor lenge vi lagrer opplysninger om deg</h2>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Administrative opplysninger</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Pasientjournal</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Dokumentasjon</h3>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Digital kommunikasjon</h2>
      <p>Hvordan du kan kommunisere digitalt med oss, kan variere fra klinikk til klinikk.</p>
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Timebestilling</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">SMS og e-post</h3>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Dine rettigheter</h2>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Innsyn</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Retting</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Sletting</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Dataportabilitet</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Protest</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Rett til begrensning av behandling</h3>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Samtykke</h2>
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Helseforsikring</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Innhenting av relevante opplysninger fra andre behandlere</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Kvalitetsregister og forskning</h3>
      ...
      <h3 className="text-lg md:text-xl font-normal text-foreground mt-6 mb-2">Nyhetsbrev</h3>
    ...
    <section>
      <h2 className="text-2xl md:text-3xl font-light text-foreground mt-12 mb-4">Endringer i denne erklæringen</h2>
