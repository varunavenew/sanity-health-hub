    ...
    <div className="fixed inset-0 z-50 bg-black">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <div className="absolute top-8 left-0 right-0 text-center z-10">
          <p className="text-white text-lg font-medium bg-black/50 backdrop-blur-sm px-6 py-3 rounded-2xl md:rounded-full inline-block">
            {instruction}
          </p>
        </div>
        ...
        <Button
          ...
          size="icon"
          onClick={onClose}
          className="absolute top-4 right-4 text-white hover:bg-white/20 rounded-2xl md:rounded-full"
        >
          <X className="w-6 h-6" />
        </Button>
