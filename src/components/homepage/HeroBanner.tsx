...
import mobilKvinnehelseAsset from "@/assets/hero/mobil-graviditet-hero.jpg.asset.json";
...
const mobilKvinnehelse = mobilKvinnehelseAsset.url;
    ...
    >
      <AnimatePresence custom={direction} mode="popLayout">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 pb-14 md:pb-24">
