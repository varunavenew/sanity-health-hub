...
export const SplitCurtainReveal = ({ onComplete }: SplitCurtainRevealProps) => {
 ...
 <motion.p
 className="text-white text-xl md:text-3xl lg:text-4xl font-light leading-relaxed"
 ...
 <motion.p
 className="text-brand-dark text-xl md:text-3xl lg:text-4xl font-light leading-relaxed"
 initial={{ opacity: 0, x: 30 }}
 animate={{ opacity: 1, x: 0 }}
