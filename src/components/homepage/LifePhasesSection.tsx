...
const staticFaqs = [
  ...
  },
  {
    id: "forsikring",
    question: "Forsikring",
    answer: "Vi har avtale med de fleste forsikringsselskaper, inkludert EuroAccident, Falck, Fremtind, Gjensidige, Storebrand, Tryg, Vertikal Helse og Vialia. Kontakt ditt forsikringsselskap for å sjekke hva din forsikring dekker, og be om å få time hos CMedical.",
  },
];
  ...
  return (
    <section id="life-phases" className="bg-background">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="mt-2 mb-8 md:mb-10 text-center">
          <button
            onClick={() => navigate('/booking')}
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-brand-dark rounded-2xl font-normal hover:bg-white/90 transition-colors max-sm:w-full max-sm:h-12 max-sm:py-0"
          >
