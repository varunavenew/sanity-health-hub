      ...
      <div className="page-shell">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10 md:mb-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/spesialister"
              className="inline-flex items-center gap-2 px-5 py-2.5 border border-foreground/20 rounded-2xl text-foreground font-light hover:bg-secondary transition-colors"
            >
