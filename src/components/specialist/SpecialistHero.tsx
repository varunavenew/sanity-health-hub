...
export const SpecialistHero = ({ specialist, onScrollToBooking }: SpecialistHeroProps) => {
  ...
  return (
    <div className="relative">
      {/* Dark background — ends before image bottom */}
      <div className="bg-[#42332A] pt-32 md:pt-36 pb-24 md:pb-32" />

      {/* Content overlaid so image bleeds past the dark bg */}
      <div className="absolute inset-x-0 top-0 pt-32 md:pt-36">
        <div className="container mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 md:gap-10 items-start">
            ...
            {/* Left: Text */}
            <div className="pb-10 md:pb-14 order-1">
              <motion.span
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            {/* Right: Portrait — bleeds below the dark section */}
            <motion.div
      ...
      {/* Spacer to push content below the overlapping image */}
      <div className="h-[280px] md:h-[200px] lg:h-[220px]" />
    </div>
  );
};
