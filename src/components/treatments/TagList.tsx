...
export const TagList = ({ tags, initialVisible = 3, className = "" }: TagListProps) => {
  ...
  const pillClass =
    "text-xs font-light text-foreground/70 border border-foreground/15 px-2 py-1 rounded-[var(--radius)]";
  const linkPillClass =
    "text-xs font-normal text-foreground border border-foreground/30 px-2 py-1 rounded-[var(--radius)] bg-foreground/[0.02] hover:bg-foreground hover:text-background hover:border-foreground transition-colors cursor-pointer";
