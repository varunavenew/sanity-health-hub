                ...
                <Card className="group hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 hover:border-primary/20 hover:-translate-y-2">
                  <div className="relative overflow-hidden aspect-square">
                    <img
                      ...
                      loading="lazy"
                    />
                    <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm px-3 py-2 rounded-2xl md:rounded-full shadow-lg flex items-center gap-1">
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <Button size="sm" className="rounded-2xl md:rounded-full">
                        Kjøp nå
                      </Button>
                    </div>
                  </div>
