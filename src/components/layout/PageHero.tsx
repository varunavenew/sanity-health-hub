...
export const PageHero = ({ 
  ...
  return (
    <header className={`pt-[4.5rem] pb-10 md:pt-40 md:pb-28 ${dark ? 'bg-brand-dark' : 'bg-gradient-to-b from-secondary/50 to-background'}`}>
      <div className="container mx-auto px-6 md:px-16">
        <div className="max-w-3xl">
          {badge && (
            <div className={`inline-flex items-center gap-2 text-sm font-normal mb-6 ${
