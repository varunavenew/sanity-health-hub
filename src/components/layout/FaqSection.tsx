...
interface FaqSectionProps {
  ...
  title?: string;
  /** Optional supporting copy under the title (split layout). */
  description?: string;
  ...
  /** Open the first item by default (reference graviditet behaviour). */
...
export const FaqSection = ({
  ...
  const [openFaq, setOpenFaq] = useState<string | null>(() =>
    defaultOpenFirst && faqs[0] ? faqs[0].id : null,
  );
