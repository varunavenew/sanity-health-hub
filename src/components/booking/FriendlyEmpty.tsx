...
export const FriendlyEmpty = ({
  ...
  return (
    <div className="p-6 bg-white rounded-lg text-center space-y-4">
      ...
      <a
        href={telHref}
        className="inline-flex items-center gap-2 px-4 py-2.5 bg-foreground text-background rounded-2xl md:rounded-full text-sm hover:bg-foreground/90 transition-colors"
      >
