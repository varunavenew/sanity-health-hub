        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="divide-y divide-border/60">
            {clinics.map((clinic: any) => (
              <div key={clinic.id} className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-0">
                ...
                <div className="sm:w-[30%] flex items-center gap-2 ml-6 sm:ml-0">
                  ...
                  <a href={`tel:+47${clinic.phone.replace(/\s/g, '')}`} className="text-xs text-foreground hover:underline font-light">
                    {clinic.phone}
                  </a>
                </div>
                <div className="sm:w-[30%] flex items-center gap-2 ml-6 sm:ml-0">
